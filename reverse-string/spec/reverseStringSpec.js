...
describe("Produce the reverse order of a word: ", function() {
  ...
  describe("Case for palindromes", function() {
    ...
    it("should return true for `SoS`", function() {
      expect(reverseString('SoS')).toEqual(true);
    });
    ...
    it("should return true for `1000000001`", function() {
      expect(reverseString('1000000001')).toEqual(true);
    });
  ...
  describe("Case for normal words", function() {
    ...
    it("should return `ssehc` for `chess`", function() {
      expect(reverseString('chess')).toEqual('ssehc');
    });
    ...
    it("should return `ynohtna` for `anthony`", function() {
      expect(reverseString('anthony')).toEqual('ynohtna');
    });

    it("should return `!alednA` for `Andela!`", function() {
      expect(reverseString('Andela!')).toEqual('!alednA');
    });
