describe("words()", function() {
  ...
  it("counts 10 'Monsters'", function() {
    var expectedCounts = { 'Monster': 10 };
    expect(words("Monster Monster Monster Monster Monster Monster Monster Monster Monster Monster")).toEqual(expectedCounts);
  });

  it("counts 1 'problem' and 20 'bugs' ", function() {
    var expectedCounts = { bug: 20, problem: 1};
    expect(words("bug bug bug bug bug bug bug problem bug bug bug bug bug bug bug bug    bug bug bug bug bug")).toEqual(expectedCounts);
  });
